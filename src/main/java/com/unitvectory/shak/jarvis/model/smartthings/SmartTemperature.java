...
public class SmartTemperature extends SmartEvent {
	 ...
	 * The history query.
	 */
	private static final String HistoryQuery = "INSERT INTO smart_temperature_event (device, eventid, value, unit, occurred) VALUES (?,?,?,?,?)";
	 ...
	 * The recent query.
	 */
	private static final String RecentQuery = "INSERT INTO smart_temperature_recent (device, eventid, value, unit, occurred) "
			+ "VALUES (?,?,?,?,?) "
