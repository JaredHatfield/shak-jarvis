...
public class SmartRssi extends SmartEvent {
	 ...
	 */
	public SmartRssi(String hubId, String locationId, String deviceId,
			String eventId, String date, double value) throws SmartException {
		super("rssi", hubId, locationId, deviceId, eventId, date);
		this.value = value;
	}
	 ...
	 * The history query.
	 */
	private static final String HistoryQuery = "INSERT INTO smart_rssi_event (device, eventid, value, occurred) VALUES (?,?,?,?)";
	 ...
	 * The recent query.
	 */
	private static final String RecentQuery = "INSERT INTO smart_rssi_recent (device, eventid, value, occurred) "
			+ "VALUES (?,?,?,?) "
	...
	public SmartEvent getPreviousObject(ResultSet rs) throws SQLException,
		...
		return new SmartRssi(hubId, locationId, deviceId, eventId, occurred,
				value);
	}
}
