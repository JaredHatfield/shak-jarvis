 ...
 * 
 */
public class SmartBattery extends SmartEvent {
	...
	/**
	 * Creates a new instance of the SmartBattery class.
	 * 
	 * @param hubId
	 *            the hubId
	 * @param locationId
	 ...
	 */
	public SmartBattery(String hubId, String locationId, String deviceId,
			String eventId, String date, double value) throws SmartException {
		super("battery", hubId, locationId, deviceId, eventId, date);
		this.value = value;
	}
	 ...
	 * @throws SmartException
	 */
	public SmartBattery(SmartThingsPublish publish) throws SmartException {
		super("battery", publish.getHubId(), publish.getLocationId(), publish
	 ...
	 * The history query.
	 */
	private static final String HistoryQuery = "INSERT INTO smart_battery_event (device, eventid, value, occurred) VALUES (?,?,?,?)";
	 ...
	 * The recent query.
	 */
	private static final String RecentQuery = "INSERT INTO smart_battery_recent (device, eventid, value, occurred) "
			+ "VALUES (?,?,?,?) "
