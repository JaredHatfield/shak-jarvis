...
public class SmartThreeAxis extends SmartEvent {
	 ...
	 * The history query.
	 */
	private static final String HistoryQuery = "INSERT INTO smart_threeaxis_event (device, eventid, valX, valY, valZ, occurred) VALUES (?,?,?,?,?,?)";
	 ...
	 * The recent query.
	 */
	private static final String RecentQuery = "INSERT INTO smart_threeaxis_recent (device, eventid, valX, valY, valZ, occurred) "
			+ "VALUES (?,?,?,?,?,?) "
