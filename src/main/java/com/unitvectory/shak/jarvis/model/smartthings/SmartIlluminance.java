...
public class SmartIlluminance extends SmartEvent {
	 ...
	 */
	public SmartIlluminance(String hubId, String locationId, String deviceId,
			String eventId, String date, double value) throws SmartException {
		super("illuminance", hubId, locationId, deviceId, eventId, date);
		this.value = value;
	}
	 ...
	 * The history query.
	 */
	private static final String HistoryQuery = "INSERT INTO smart_illuminance_event (device, eventid, value, occurred) VALUES (?,?,?,?)";
	 ...
	 * The recent query.
	 */
	private static final String RecentQuery = "INSERT INTO smart_illuminance_recent (device, eventid, value, occurred) "
			+ "VALUES (?,?,?,?) "
	...
	private static final String PreviousQuery = "SELECT d.hubid, "
			...
			+ "FROM smart_illuminance_event e "
	...
	public SmartEvent getPreviousObject(ResultSet rs) throws SQLException,
		...
		return new SmartIlluminance(hubId, locationId, deviceId, eventId,
				occurred, value);
	}
}
