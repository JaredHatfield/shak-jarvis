...
public class SmartHumidity extends SmartEvent {
	 ...
	 * The history query.
	 */
	private static final String HistoryQuery = "INSERT INTO smart_humidity_event (device, eventid, value, occurred) VALUES (?,?,?,?)";
	 ...
	 * The recent query.
	 */
	private static final String RecentQuery = "INSERT INTO smart_humidity_recent (device, eventid, value, occurred) "
			+ "VALUES (?,?,?,?) "
