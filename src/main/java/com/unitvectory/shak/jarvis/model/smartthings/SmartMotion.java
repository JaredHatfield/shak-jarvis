...
public class SmartMotion extends SmartEvent {
	 ...
	 */
	public SmartMotion(String hubId, String locationId, String deviceId,
			String eventId, String date, char status) throws SmartException {
		super("motion", hubId, locationId, deviceId, eventId, date);
		this.status = status;
	}
	 ...
	 * The history query.
	 */
	private static final String HistoryQuery = "INSERT INTO smart_motion_event (device, eventid, status, occurred) VALUES (?,?,?,?)";
	 ...
	 * The recent query.
	 */
	private static final String RecentQuery = "INSERT INTO smart_motion_recent (device, eventid, status, occurred) "
			+ "VALUES (?,?,?,?) "
