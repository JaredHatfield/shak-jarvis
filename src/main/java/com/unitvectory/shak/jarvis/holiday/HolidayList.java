...
public class HolidayList {
    ...
    public HolidayList() {
        // Get the messages
        this.messages =
                ResourceBundle.getBundle("Holidays", Locale.getDefault());

        // Populate the years
        this.holidays =
                new TreeMap<Integer, Map<Integer, Map<Integer, List<String>>>>();
    ...
    private void populateYear(int yearNumber) {
        ...
        Map<Integer, Map<Integer, List<String>>> year =
                new TreeMap<Integer, Map<Integer, List<String>>>();
        this.holidays.put(yearNumber, year);

        for (int monthNumber = 1; monthNumber <= 12; monthNumber++) {
            Map<Integer, List<String>> month =
